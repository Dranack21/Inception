...
## Requirements:
For the project to cwork on your machine you will need to have docker installed 
You can do it as such (assuming that you're using apt has a package manager)
```bash
